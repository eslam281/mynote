...
class AppLocalizations {
  ...
  static final Map<String, Map<String, String>> _localizedValues = {
    'en': {
      ...
      'quote': '"Programming is not just code, it is the art of solving problems"',
      'dev_name': 'Islam Sayed Abdelaziz',
      'dev_role': 'Mobile App Developer (Flutter)',
      'dev_edu': 'Faculty of Computers and Information - Thebes Academy',
      'skill_1': 'Problem solving, Data Structures & Algorithms',
      'skill_2': 'OOP principles and modern software engineering',
      'skill_3': 'Relational databases (MySQL)',
      'skill_4': 'Proficiency in Flutter, Dart, REST API, Git',
      'proj_1': 'Integrated e-commerce system (3 apps)',
      'proj_2': 'Responsive UI using GetX',
      'proj_3': 'Advanced Backend using PHP & MySQL',
      'proj_4': 'Smart tracking and electronic payment systems',
      'pers_1': 'Love for sharing knowledge and technical volunteering',
      'pers_2': 'Ability to work in a team and lead teams',
      'pers_3': 'Respect for work ethics and professionalism',
      'pers_4': 'Quick search and finding creative solutions',
    },
    'ar': {
      'app_title': 'ملاحظاتي',
      'home': 'ملاحظاتي',
      ...
      'quote': '"البرمجة ليست مجرد كود، بل هي فن حل المشكلات"',
      'dev_name': 'إسلام سيد عبد العزيز',
      'dev_role': 'مطور تطبيقات موبايل (Flutter)',
      'dev_edu': 'كلية الحاسبات والمعلومات - أكاديمية طيبة',
      'skill_1': 'حل المشكلات، هياكل البيانات والخوارزميات',
      'skill_2': 'مبادئ OOP وهندسة البرمجيات الحديثة',
      'skill_3': 'قواعد البيانات العلائقية (MySQL)',
      'skill_4': 'إتقان Flutter, Dart, REST API, Git',
      'proj_1': 'نظام متجر إلكتروني متكامل (3 تطبيقات)',
      'proj_2': 'واجهة مستخدم متجاوبة باستخدام GetX',
      'proj_3': 'باك إند متطور باستخدام PHP و MySQL',
      'proj_4': 'أنظمة تتبع ودفع إلكتروني ذكية',
      'pers_1': 'حب مشاركة المعرفة والتطوع التقني',
      'pers_2': 'القدرة على العمل الجماعي وقيادة الفرق',
      'pers_3': 'احترام أخلاقيات العمل والاحترافية',
      'pers_4': 'البحث السريع وإيجاد حلول إبداعية',
    },
  };
